            ...
            <div className="header-hero">
                <div className="heading-text">
                    <div style={{width: '20rem'}} className="shadow text-white px-3 py-2 ">
                        ...
                        <p className="text-white">You're all invited tofive-day festival o a f Olympian & Paralympian Online Experiences. Join unique activities on Airbnb hosted by some of the world’s greatest athletes, like Allyson Felix, Lex Gillette, Naomi Osaka and many more. Starts on 24 July</p>
