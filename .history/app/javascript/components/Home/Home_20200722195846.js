            ...
            <div className="header-hero">
                <div className="heading-text">
                    <div style={{width: '20rem'}} className="shadow text-white px-3 py-2 ">
                        ...
                        <p className="text-white">You're all invited to Our upcoming Bike tour which happens once every decade. Taking place at colorado at the foot of the Rocky Mountains. Bikers from all over the globe will be present. Starts on 24 July</p>
