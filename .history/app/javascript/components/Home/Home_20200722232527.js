        ...
        <div>
            <div class="header timer-container py-5">
                ...
                <div className="time-small-container">
                    <div className="time-small"><span>2</span> Months</div>
                    <div><span>3</span> Days</div>
                    <div><span>10</span> Hours</div>
                    <div><span>4</span> Min</div>
                    <div><span>10</span> Sec</div>
            ...
            <div className="header-hero">
                <div className="heading-text">
                    <div className=" card-width shadow text-white px-3 py-2 ">
                        <h4 className="text-white">Connect with the world best bikers at the Boulder Bike Tour</h4>
