...
class Map extends Component {
   ...
   render(){
       ...
       return (
           <GoogleMap defaultZoom={10} defaultCenter={{ lat: 40.014984, lng: -105.270546 }}>
               ...
               {selectedRider && (
                   ...
                   >
                       ...
                       <div>
                           <h2>Fullname: {selectedRider.first_name + ' - ' + selectedRider.last_name}</h2>
                           <p>City : {selectedRider.city}</p>
                           <p>State : {selectedRider.state}</p>
                       </div>
